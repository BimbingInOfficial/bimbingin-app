...
import 'package:bimbingin_app/app/modules/root/views/root_view.dart';
...
class KuesionerGuruView extends GetView<KuesionerController> {
  const KuesionerGuruView({super.key});
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        'Yuk Jawab Biar BimbingIn Tahu Gaya Mengajarmu',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // Pertanyaan 1
                  _buildQuestionCard(
                    'Seberapa sering kamu membantu siswa memahami cara menggunakan prinsip atau konsep dalam kehidupan nyata?',
                    2, // 03 selected
                  ),
                  ...
                  // Pertanyaan 2
                  _buildQuestionCard(
                    'Seberapa penting bagimu untuk berbagi ilmu dan pengalaman dengan siswa?',
                    3, // 04 selected
                  ),
                  SizedBox(height: AppSpacing.lg),
                  ...
                  // Pertanyaan 3
                  _buildQuestionCard(
                    'Apakah kamu menetapkan standar yang tinggi untuk siswa di kelas?',
                    1, // 02 selected
                  ),
                  SizedBox(height: AppSpacing.lg),
                  ...
                  // Pertanyaan 4
                  _buildQuestionCard(
                    'Apakah harapan dan standar darimu bisa mendorong siswa jadi lebih disiplin dalam belajar?',
                    4, // 05 selected
                  ),
